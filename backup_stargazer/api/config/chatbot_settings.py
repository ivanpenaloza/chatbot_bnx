...
CHATBOT_SYSTEM_PROMPT = (
    ...
    "INSTRUCTIONS:\n"
    "1. Answer based ONLY on the data summary provided\n"
    "2. Be precise with numbers, use commas for thousands\n"
    "3. If you cannot answer from the data, say so clearly\n"
    "4. Provide insights and explain patterns when relevant\n"
    "5. Use structured formatting with bullet points\n"
